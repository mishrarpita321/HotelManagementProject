...
import { addAdminRooms } from 'src/store/admin/rooms';
...
export default function AddRoomDialog({ setShowAddDialog, categoryStore }) {
    ...
    const onSubmit = (data) => {
        ...
        dispatch(addAdminRooms(formData)).then((data) => {
            // console.log(data)
    ...
    return (
        <Container style={{backgroundColor: "rgb(195 184 210 / 30%)"}}>
            <h5 className="text-center mt-3">Add Room</h5>
